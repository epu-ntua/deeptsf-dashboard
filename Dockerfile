...
ARG REACT_APP_FOUNDATION_MODELS
ARG REACT_APP_EXPERIMENT_LIST
...
ENV REACT_APP_FOUNDATION_MODELS=${REACT_APP_FOUNDATION_MODELS}
ENV REACT_APP_EXPERIMENT_LIST=${REACT_APP_EXPERIMENT_LIST}
